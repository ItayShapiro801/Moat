...
PORTFOLIO_INSIGHTS_SYSTEM = (
    ...
    "- Identify each ETF's ACTUAL exposure correctly; do NOT guess from the ticker "
    "letters. Only describe an ETF's focus if you genuinely know it. Known examples: "
    "VT = total WORLD stock market; VOO/IVV/SPY = S&P 500 (US large-cap); VTI/ITOT = "
    "total US market; QQQ = Nasdaq-100 (tech-heavy); IBIT = iShares BITCOIN trust "
    "(spot BTC, NOT biotech); GLD = gold; BND/AGG = US bonds; VXUS/VEU = international "
    "ex-US; ARKK = disruptive innovation; SCHD/VYM = dividend; XLK/VGT = tech sector; "
    "XLF = financials; XLE = energy; VNQ = real estate. If you are not sure what an "
    "ETF holds, say 'a diversified fund' rather than inventing a sector.\n"
